 ...
 */
@Display("出货安排单")
public class DeliveryAssignmentVo{

    public DeliveryAssignmentVo(){
    ...
    @FieldExport(name = "创建时间")
    private LocalDateTime createdAt;

    @FieldExport(name = "修改时间")
    ...
    @Display("出货安排单号")
    @FieldExport(name = "出货安排单号")
    private String code;
    @Display("销售组织主键")
    private String saleOrgId;
    @Display("销售组织编码")
    @FieldExport(name = "销售组织编码")
    ...
    @FieldExport(name = "交货日期")
    @Display("交货日期")
    private LocalDateTime scheduledFor;

    @FieldExport(name = "短发补发")
    ...
    @Display("结算方式编码")
    @FieldExport(name = "结算方式编码")
    private String settlementTypeCode;

    @Display("结算方式名称")
    @FieldExport(name = "结算方式名称")
    ...
    @Display("运输方式编码")
    @FieldExport(name = "运输方式编码")
    private String deliveryTypeCode;

    @Display("运输方式名称")
    @FieldExport(name = "运输方式名称")
    private String deliveryTypeName;

    @FieldExport(name = "配送省")
    private String provinceId;
    @FieldExport(name = "配送省名称")
    private String provinceName;

    @FieldExport(name = "配送市")
    private String cityId;

    @FieldExport(name = "配送市编码")
    private String cityCode;

    @FieldExport(name = "配送市名称")
    private String cityName;

    @FieldExport(name = "配送区县")
    private String countyId;

    @FieldExport(name = "配送区县名称")
    private String countyName;


    @FieldExport(name = "提货信息")
    private String remarkOnPick;


    @FieldExport(name = "是否板装")
     ...
     * 来源单据号
     */
    @FieldExport(name = "发货单号")
    private String srcBillCode;

    /**
     * 销售订单号
     */
    @FieldExport(name = "销售订单号")
    private String saleOrderCode;

    /**
     * 门户要货单号
     */
    @FieldExport(name = "要货单号")
    private String reqOrderCode;

    /**
     * 交货日期
     */
    @FieldExport(name = "出货安排日期")
    ...
    @Display("承运商编码")
    @FieldExport(name = "承运商编码")
    private String consignorCode;
    @Display("承运商名称")
    @FieldExport(name = "承运商名称")
    ...
    @FieldExport(name = "是否关闭")
    private Integer isClosed = 0;

    private String warehouseId;

    @FieldExport(name = "发货仓库编码")
    private String warehouseCode;
    @FieldExport(name = "发货仓库")
    ...
    @Display("发货库存组织编码")
    @FieldExport(name = "发货库存组织编码")
    private String stockOrgCode;

    @Display("发货库存组织名称")
    @FieldExport(name = "发货库存组织名称")
    private String stockOrgName;

    @FieldExport(name = "创建人")
    private String creator;

    @Display("客户主键")
    private String customerId;
    @Display("客户编码")
    @FieldExport(name = "客户编码")
    private String customerCode;
    @Display("客户名称")
    @FieldExport(name = "客户名称")
    ...
    @FieldExport(name = "总毛重")
    private BigDecimal totalWeight;

    /**
     * 总净重
     */
    @FieldExport(name = "总净重")
    private BigDecimal totalNetWeight;

    /**
     * 总体积
     */
    @FieldExport(name = "总体积")
    private BigDecimal totalVolume;

    /**
     * 总成交金额
     */
    @FieldExport(name = "总成交金额")
    ...
    public boolean equals(Object o) {
        ...
        DeliveryAssignmentVo that = (DeliveryAssignmentVo) o;
