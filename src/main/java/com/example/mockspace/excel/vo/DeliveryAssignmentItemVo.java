...
public class DeliveryAssignmentItemVo extends VersionedResponse {

    public DeliveryAssignmentItemVo(){
    ...
    @FieldExport(name = "商品编码")
    private String goodsCode;

    @FieldExport(name = "商品名称")
    private String goodsName;

    @FieldExport(name = "是否卸货")
    private Integer isDischarge = 0;

    private String supplierId;

    @FieldExport(name = "委托商编码")
    private String supplierCode;
    @FieldExport(name = "委托商名称")
    private String supplierName;

    @FieldExport(name = "本次安排数量")
    private BigDecimal num;

    @FieldExport(name = "收货地址")
    private String receiveAddress;

    @FieldExport(name = "收货人")
    ...
    @FieldExport(name = "销售部门编码")
    private String salesDeptCode;


    @FieldExport(name = "销售部门名称")
    ...
    @FieldExport(name = "客户经理编码")
    private String salesManagerCode;
    @FieldExport(name = "客户经理名称")
    ...
    @FieldExport(name = "客户分类编码")
    private String customerCategoryCode;
    @FieldExport(name = "客户分类名称")
    ...
    @FieldExport(name = "重量单位名称")
    private String weightUnitName;

    /**
     * 收货人电话
     */
    @FieldExport(name = "收货人电话")
    private String receiverPhone;

    /**
     * 备注
     */
    @FieldExport(name = "行备注")
     ...
     * 体积单位编码
     */
    @FieldExport(name = "体积单位编码")
    private String volumeUnitCode;

    /**
     * 体积单位名称
     */
    @FieldExport(name = "体积单位名称")
    private String volumeUnitName;

    /**
     * 成交价格
     */
    @FieldExport(name = "成交价格")
    private BigDecimal dealPrice;

    /**
     * 成交金额
     */
    @FieldExport(name = "成交金额")
    ...
    public boolean equals(Object o) {
        ...
        DeliveryAssignmentItemVo that = (DeliveryAssignmentItemVo) o;
